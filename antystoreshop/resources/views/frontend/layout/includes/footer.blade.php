        ...
        <div class="main-footer-content">
            ...
            <div class="container">
                                ...
                                <div class="wrap-contact-detail">
                                    <ul>
                                        <li>
                                            ...
                                            <p class="contact-txt">176 tran phu, tp-hue</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="contact-txt">(+84) 336840100 - (+84) 394919975</p>
                                        </li>
                                        <li>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-hotline-footer">
                                    ...
                                    <b class="phone-number">(+84) 336840100 - (+84) 394919975</b>
                                </div>
                            </div>
                        </div>

                        <div class="wrap-footer-item footer-item-second">
                            <h3 class="item-header">Đăng ký để nhận thêm bản tin</h3>
                            <div class="item-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                        <div class="wrap-footer-item">
                            <h3 class="item-header">Thanh toán an toàn:</h3>
                            <div class="item-content">
...
<script src="{{asset('frontendjs/jquery.flexslider.js')}}"></script>
